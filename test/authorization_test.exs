defmodule SpotifyAuthorizationTest do
  ...
  test "#call with scopes" do
    ...
    assert(Spotify.Authorization.call == "https://accounts.spotify.com/authorize?client_id=#{Spotify.client_id}&response_type=code&redirect_uri=#{Spotify.callback_url}&scope=foo%20bar")
  end
